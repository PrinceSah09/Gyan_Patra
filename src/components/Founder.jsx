      ...
      <div className=" h-auto m-auto flex flex-col md:flex-row justify-center items-center gap-4 max-w-screen-xl md:flex-wrap">
        <div className=" lg:flex-row flex gap-4 flex-col justify-center">
          ...
          <div className="lg:w-[55%] h-auto rounded-md bg-zinc-300/50 backdrop-blur-xl p-4">
            ...
            <p className="lg:text-xl w-[90%] sm:text-sm m-auto">
              ...
              deserunt non fuga nostrum optio enim atque earum fugiat quam
              dolore. Quos aliquam unde, nisi, suscipit sapiente ullam eaque
              exercitationem numquam sed ipsam, nesciunt cumque ipsum? Esse
              consectetur rem laudantium excepturi asperiores voluptas minus ex
              aperiam voluptates eum quod beatae odio nobis architecto sunt,
              ipsam earum eos, libero dolorum voluptatem illum.{" "}
            </p>
